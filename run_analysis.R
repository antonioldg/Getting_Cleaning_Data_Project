...
##1.1 Read the files into a list of tables
##Note : All files need to be copied to the working directory
library(plyr)
...
## TIDY DATA result is vector data_merged_mean_std
